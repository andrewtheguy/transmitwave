...
// Frame configuration
pub const PREAMBLE_DURATION_MS: usize = 125;  // 1/8 second for faster tests
pub const PREAMBLE_SAMPLES: usize = (SAMPLE_RATE * PREAMBLE_DURATION_MS) / 1000; // 2000
pub const POSTAMBLE_DURATION_MS: usize = 125; // 1/8 second for faster tests
pub const POSTAMBLE_SAMPLES: usize = (SAMPLE_RATE * POSTAMBLE_DURATION_MS) / 1000; // 2000
