...
// Frame configuration
pub const PREAMBLE_DURATION_MS: usize = 500;
pub const PREAMBLE_SAMPLES: usize = (SAMPLE_RATE * PREAMBLE_DURATION_MS) / 1000; // 8000
pub const POSTAMBLE_DURATION_MS: usize = 500;
pub const POSTAMBLE_SAMPLES: usize = (SAMPLE_RATE * POSTAMBLE_DURATION_MS) / 1000; // 8000
